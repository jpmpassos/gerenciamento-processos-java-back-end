package br.com.gerencproces.exceptionhandler;
...
@ControllerAdvice
public class GerencProcesExceptionHandler extends ResponseEntityExceptionHandler {
	@Autowired
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(NoSuchAlgorithmException ex,
			WebRequest request) {
		String mensagemUsuario = messageSource.getMessage("recurso.operacao-nao-permitida", null,
				LocaleContextHolder.getLocale());
		String mensagemDesenvolvedor = ExceptionUtils.getRootCauseMessage(ex);
